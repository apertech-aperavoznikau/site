(function(){
  ...
  const dict = {
    ...
    ru: {
      ...
      // Psychology
      'title.psychology': 'Психолог-консультант | Артем Перевозников',
      'psych.h2': 'Психолог-консультант (гештальт)',
